                ...
                <tr>
                  <td colSpan="6" className="px-4 py-10 text-center">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                      {new Date(plan.createdAt).toLocaleDateString('en-PH', {
                        month: 'short',
                        day: 'numeric',
                        year: 'numeric'
                      })}
                        ...
                        <div className="flex items-center justify-end space-x-2">
                          {plan.status === 'Proposed' && (
                            <button
                              onClick={() => handleUpdateStatus(plan._id, 'In Progress')}
                              disabled={updating === plan._id}
                              className="inline-flex items-center px-2.5 py-1.5 rounded-md text-xs font-medium bg-yellow-50 text-yellow-700 border border-yellow-200 hover:bg-yellow-100 disabled:opacity-50 transition"
                              title="Start treatment"
                            >
                              {updating === plan._id ? '...' : 'Start'}
                            </button>
                          ...
                          {plan.status === 'In Progress' && (
                            <button
                              onClick={() => handleUpdateStatus(plan._id, 'Completed')}
                              disabled={updating === plan._id}
                              className="inline-flex items-center px-2.5 py-1.5 rounded-md text-xs font-medium bg-green-50 text-green-700 border border-green-200 hover:bg-green-100 disabled:opacity-50 transition"
                              title="Mark as completed"
                            >
                              {updating === plan._id ? '...' : 'Complete'}
                            </button>
                          ...
                          <button
                            onClick={() => handleUpdateStatus(plan._id, 'Cancelled')}
                            disabled={updating === plan._id}
                            className="inline-flex items-center px-2.5 py-1.5 rounded-md text-xs font-medium bg-red-50 text-red-700 border border-red-200 hover:bg-red-100 disabled:opacity-50 transition"
                            title="Cancel plan"
                          >
                            Cancel
                          </button>
                ...
                <tr>
                  <td colSpan="6" className="px-4 py-10 text-center">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm text-gray-500 font-medium">No treatment plans yet</p>
                      <p className="text-xs text-gray-400 mt-1">Click "Add Plan" to create one.</p>
                    </div>
                  </td>
                </tr>
