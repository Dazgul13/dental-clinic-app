  ...
  return (
    <div className="px-4 sm:px-0">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-3xl font-semibold text-gray-900">{appointments.length}</dd>
                </dl>
              </div>
            </div>
          </div>
        ...
        <Link to="/dashboard/patients" className="bg-white overflow-hidden shadow rounded-lg hover:shadow-lg transition">
          <div className="p-5">
            <div className="flex items-center">
        ...
        <Link to="/dashboard/schedule" className="bg-white overflow-hidden shadow rounded-lg hover:shadow-lg transition">
          <div className="p-5">
            <div className="flex items-center">
